        ...
        <form action="{{ url('/PostLogin') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="container">
                <div>
                    <ul>
                        <li class="img-logo">
                            <a href="./"><img style="width: 70px; height: 64px;" src="{{ asset('images/to_customer/LOGO Cemilanpuas.png') }}" alt="Logo Cemilanpuas"></a>
                        </li>
                        <li>
                        </br><h3>Masuk</h3>
                        </li>
                        ...
                        <ul>
                            <li>
                                <p style="color: black;">Selamat Datang kembali, Silahkan masukkan akun Anda</p></br>
                            </li>
                                <h5>Email</h5>
                            </li>
                            <li>
                            ...
                            <li>
                                <p style="color: black; text-align: center;">Tidak Punya Akun?  <a href="./daftar" style="color:  #FFA900;">Daftar</a></p>
                            </li>
                        </ul>                    
                        </div>
                    </ul>
                    <ul class="ul-gambar-otorisasi">
                        <div>
